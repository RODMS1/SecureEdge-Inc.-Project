...
| 4 | **Discover devices** | Discovers devices on the local network by parsing the ARP table and displays a clean list of IP and MAC addresses. May require elevated privileges. |
